...
from BGM_22.neuronmodels import poisson_neuron_up_down, poisson_neuron, izhikevich2007_standard, izhikevich2007_fsi, izhikevich2003, integrator_neuron, izhikevich2003_modified, izhikevich_str_old, izhikevich_str_fsi_old
...
def compare_str(do_compile=False, compile_folder_name='annarchy_compare_str'):
    """
        generates a basal ganglia model (model_id = compare_str) and optionally compiles the network
        
        returns a list of the names of the populations an projections (for later access)
    """
    
    params = get_params('compare_str')
    ...
    str_d1_old  = Population(params['str_d1_old__size'],  izhikevich_str_old, name="str_d1_old")
    str_d2_old  = Population(params['str_d2_old__size'],  izhikevich_str_old, name="str_d2_old")
    str_fsi_old = Population(params['str_fsi_old__size'], izhikevich_str_fsi_old, name="str_fsi_old")
    ### Noise
    ...
    str_d1_n_exc__str_d1_old       = Projection(pre=str_d1_n_exc,    post=str_d1_old,    target='ampa', synapse=factor_synapse, name='str_d1_n_exc__str_d1_old')
    str_d2_n_exc__str_d2_old       = Projection(pre=str_d2_n_exc,    post=str_d2_old,    target='ampa', synapse=factor_synapse, name='str_d2_n_exc__str_d2_old')
    str_fsi_n_exc__str_fsi_old     = Projection(pre=str_fsi_n_exc,   post=str_fsi_old,   target='ampa', synapse=factor_synapse, name='str_fsi_n_exc__str_fsi_old')
...
def old_str(do_compile=False, compile_folder_name='annarchy_old_str'):
    """
        generates a basal ganglia model (model_id = old_str) and optionally compiles the network
        
        returns a list of the names of the populations an projections (for later access)
    """
    
    params = get_params('old_str')
    ...
    ### Str Populations
    str_d1  = Population(params['str_d1__size'],  izhikevich_str_old, name="str_d1")
    str_d2  = Population(params['str_d2__size'],  izhikevich_str_old, name="str_d2")
    str_fsi = Population(params['str_fsi__size'], izhikevich_str_fsi_old, name="str_fsi")
    ### BG Populations
